...
namespace MD5
{
	...
	public class MD5
	{
		...
		protected void PerformTransformation(ref uint A,ref uint B,ref uint C, ref uint D)
		{
            ...
            TransF(ref A,B,C,D,0,7,1); Console.WriteLine("A1={0:X}, B={1:X}, C={2:X}, D={3:X}",A,B,C,D); TransF(ref D,A,B,C,1,12,2); Console.WriteLine("A1={0:X}, B={1:X}, C={2:X}, D={3:X}", A, B, C, D); TransF(ref C,D,A,B,2,17,3);TransF(ref B,C,D,A,3,22,4);
			...
			TransF(ref A,B,C,D,12,7,13);TransF(ref D,A,B,C,13,12,14);TransF(ref C,D,A,B,14,17,15);TransF(ref B, C, D, A, 15, 22, 16); Console.WriteLine("A1={0:X}, B={1:X}, C={2:X}, D={3:X}", A, B, C, D);
			...
			*/
            ...
            TransG(ref A,B,C,D,1,5,17); Console.WriteLine("A1={0:X}, B={1:X}, C={2:X}, D={3:X}", A, B, C, D); TransG(ref D,A,B,C,6,9,18); Console.WriteLine("A1={0:X}, B={1:X}, C={2:X}, D={3:X}", A, B, C, D); TransG(ref C,D,A,B,11,14,19);TransG(ref B,C,D,A,0,20,20);
			...
			TransG(ref A,B,C,D,13,5,29);TransG(ref D,A,B,C,2,9,30);TransG(ref C,D,A,B,7,14,31);TransG(ref B,C,D,A,12,20,32); Console.WriteLine("A1={0:X}, B={1:X}, C={2:X}, D={3:X}", A, B, C, D);
            /*  ROUND 3
            ...
            TransH(ref A,B,C,D,5,4,33); Console.WriteLine("A1={0:X}, B={1:X}, C={2:X}, D={3:X}", A, B, C, D); TransH(ref D,A,B,C,8,11,34); Console.WriteLine("A1={0:X}, B={1:X}, C={2:X}, D={3:X}", A, B, C, D); TransH(ref C,D,A,B,11,16,35);TransH(ref B,C,D,A,14,23,36);
			...
			TransH(ref A,B,C,D,9,4,45);TransH(ref D,A,B,C,12,11,46);TransH(ref C,D,A,B,15,16,47);TransH(ref B,C,D,A,2,23,48); Console.WriteLine("A1={0:X}, B={1:X}, C={2:X}, D={3:X}", A, B, C, D);
            /*ORUNF  4
            ...
            TransI(ref A,B,C,D,0,6,49); Console.WriteLine("A1={0:X}, B={1:X}, C={2:X}, D={3:X}", A, B, C, D); TransI(ref D,A,B,C,7,10,50); Console.WriteLine("A1={0:X}, B={1:X}, C={2:X}, D={3:X}", A, B, C, D); TransI(ref C,D,A,B,14,15,51);TransI(ref B,C,D,A,5,21,52);
			...
			TransI(ref A,B,C,D,4,6,61);TransI(ref D,A,B,C,11,10,62);TransI(ref C,D,A,B,2,15,63);TransI(ref B,C,D,A,9,21,64); Console.WriteLine("A1={0:X}, B={1:X}, C={2:X}, D={3:X}", A, B, C, D);
